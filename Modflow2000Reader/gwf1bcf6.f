C     Last change:  ERB  12 Sep 2002    4:21 pm
     ...
     2  WETFCT,IWETIT,IHDWET,HDRY,IAPART,IFREFM,LAYHDT,ierror)
C
...
c###         CALL SGWF1BCF6C(CR,CC,TRPY,DELR,DELC,KK,NCOL,NROW,NLAY)
c###      ELSE IF(LAYAVG(K).EQ.10) THEN
c###         CALL SGWF1BCF6A(CR,CC,TRPY,DELR,DELC,KK,NCOL,NROW,NLAY)
c###      ELSE
c###         CALL SGWF1BCF6L(CR,CC,TRPY,DELR,DELC,KK,NCOL,NROW,NLAY)
c###      END IF
c###   70 CONTINUE
C
