C     Last change:  AWH  05 June 2000
      SUBROUTINE GWF1GHB6AL(ISUM,LCBNDS,MXBND,NBOUND,IN,IOUT,IGHBCB,
     1     NGHBVL,IGHBAL,IFREFM,NPGHB,IGHBPB,NGHBNP,ierror)
C
...
C###      IF (ITERP.EQ.1) WRITE(IOUT,3) NPGHB
...
C3------IF THERE ARE NEW NON-PARAMETER GHB'S, READ THEM.
      MXACTB=IGHBPB-1
      IF(ITMP.GT.0) THEN
         IF(NGHBNP.GT.MXACTB) THEN
C###            WRITE(IOUT,99) NGHBNP,MXACTB
...
C###            STOP
         END IF
         CALL ULSTRD(NGHBNP,BNDS,1,NGHBVL,MXBND,IGHBAL,IN,IOUT,
