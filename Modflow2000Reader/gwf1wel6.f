C     Last change:  AWH   05 JUNE 2000
     ...
     1        NWELVL,IWELAL,IFREFM,NPWEL,IPWBEG,NNPWEL,ierror)
C
...
C
      ITERPU=ITERP
c      IF (NOPRWL.EQ.1) ITERPU=99
C-------READ NAMED PARAMETERS
C###      IF(ITERP.EQ.1) WRITE(IOUT,3) NPWEL
...
C6------RETURN
     ...
     &              IFREFM,NCOL,NROW,NLAY,NNPWEL,NPWEL,IPWBEG,ierror)
C
