...
public:
	...
	// m_LayeredMesh is not currently used.  If it becomes possible to 
	// filter the grid lines in layerd meshes, m_LayeredMesh would be
	// used in activating or deactivating controls.
	BOOL m_LayeredMesh;
...
// Dialog Data
	...
	CButton	m_ActivateOutlineCheckBox;
...
protected:
	...
	afx_msg void OnRadioDisplayNone();
	afx_msg void OnRadioDisplayMesh();
	afx_msg void OnRadioDisplayLines();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()

	void OnMeshOutlineChoice(); 
};
